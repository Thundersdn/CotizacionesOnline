class UsuariosController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @usuario.update(usuario_params)
        ...
        format.html { redirect_to @usuario, notice: 'Usuario actualizado satisfactoriamente.' }
  ...
  private
    ...
    def usuario_params
      params.require(:usuario).permit(:rut, :nombre, :password, :privilegios, :ultimo_login)
    end
end
